...
// refer to: https://discuss.leetcode.com/topic/76314/3-line-clean-and-easy-understand-solution
// modified

/**
 * 找两个正整数使其积为给定值，且两个数的差值最小。输出时大的数在前面
 */
/**
 * 先取开方值，舍尾
 * 每次将开方值减1，循环判断能否被给定值整除，知道整除为止
 */
